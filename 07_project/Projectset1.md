...
## Project6(changing background color by start and stop button)
...
const  startChangingColor = function(){
  if(!intervalId){ // professional code
...
const stopChangingColor = function (){
  ...
  intervalId = null // remove all values from intervalId . professional code
}
